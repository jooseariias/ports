        ...
        <div className="text-center lg:text-left lg:w-1/2">
          ...
          <div className="flex flex-wrap gap-4 mt-6 justify-center lg:justify-start">
            ...
            <div className="flex gap-2">
              <button className="relative  hover:animate-pulse hover:bg-gray-900 hover:cursor-pointer transition duration-500 p-3 border-2 rounded-2xl border-white/20 backdrop-blur-sm text-white">
                <FiGithub />
              </button>
              <button className="relative hover:animate-pulse hover:cursor-pointer hover:bg-gray-900 transition  duration-500 p-3 border-2 rounded-2xl border-white/20 backdrop-blur-sm text-white">
                <TiSocialLinkedin />
              </button>
            </div>
          </div>
