          ...
          <div>
            <div className="relative p-8 bg-card rounded-3xl shadow-2xl border-2 border-white">
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full hover:cursor-pointer py-3 text-white bg-primary rounded-xl transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-primary/80 focus:outline-none focus:ring-4 focus:ring-primary/50 border-2 border-white"
                >
                  {t('contact.send')}
                </button>
              </form>
